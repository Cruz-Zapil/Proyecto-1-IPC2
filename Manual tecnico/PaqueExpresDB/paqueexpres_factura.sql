...
CREATE TABLE `factura` (
  ...
  KEY `factura_destino_FK` (`Lugar`),
  CONSTRAINT `factura_destino_FK` FOREIGN KEY (`Lugar`) REFERENCES `destino` (`id_destino`),
  CONSTRAINT `factura_ibfk_1` FOREIGN KEY (`id_cliente`) REFERENCES `cliente` (`id_cliente`),
  CONSTRAINT `factura_ibfk_2` FOREIGN KEY (`id_recepcionista`) REFERENCES `usuario` (`id_usuario`)
