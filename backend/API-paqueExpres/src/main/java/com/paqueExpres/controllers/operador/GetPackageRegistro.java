...
@WebServlet("/get-package-registro")
public class GetPackageRegistro  extends HttpServlet{
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            listaDeDatos = registroPuntoDAO.getPaqueteRegistro( condicion);

            /// verficar si existe el cliente:
            if (listaDeDatos.length() != 0) {
                jsonResponse.put("success", true);
                jsonResponse.put("message", "El registro paquete existe");
